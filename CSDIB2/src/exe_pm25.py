...
path = "/workspace/CSDIB2/config/" + args.config
...
foldername = r"/workspace/CSDIB2/save"
pure_evaluate = False
...
if not pure_evaluate:
    ...
    forecast_model.load_state_dict(torch.load("/workspace/CSDIB2/save/model_epoch5.pth"))
